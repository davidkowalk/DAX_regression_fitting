...
void get_gradient_double(double (*f)(double*, unsigned int), double *x, double dx, double *gradient, unsigned int len) {
  double df;
...
void gradient_descent_double(double (*f)(double*, unsigned int), unsigned int dimensions, double *start, double precision, double gamma, unsigned int max_iterations, double dx, double *output, double *output_precision, unsigned int *iterations) {
